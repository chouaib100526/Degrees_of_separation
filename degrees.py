...
def shortest_path(source, target):
    ...
    # Initialize the frontier with the source node (the starting point)
    frontier = QueueFrontier()
    start_node = Node(state=source, parent=None, action=None)
    frontier.add(start_node)

    # Create a set to keep track of explored nodes (person_id)
    explored = set()
    ...
    while not frontier.empty():
        ...
        # If we have already explored this person, skip it
        ...
        # If the target person is found, reconstruct the path
